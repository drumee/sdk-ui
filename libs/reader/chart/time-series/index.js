...
class __chart_mutiline extends LetcBox {
  ...
  async reload() {
    ...
    this.debug("AAA:28", this, dataset, axis);
  ...
  async draw() {
    ...
    const yAccessor = (d) => {
      // this.debug("AAA:yAccessor", d, rules.y)
      return d.size;
    };
    ...
    // this.debug("AAA:54", dataset, dataset[0], xAccessor(dataset[0]));
