...
const a = {
  ...
  security_sms:function(s,f){import('window/account/security/sms').then(m=>{s(m.default)}).catch(f)},
  security_usb:function(s,f){import('window/account/security/usb').then(m=>{s(m.default)}).catch(f)},
